...
<?php
require_once "../SistemaLabUtepsa/controladores/prestamos_Controlador.php";
                ...
                <div
                    ...
                    <div>
                        <p class="TextUbuntu_Bold txt_ExtraGrande">
                            <?php prestamos_Controlador::ExtraerCantidad("Completados"); ?>
                        </p>
            ...
            <div class="divContenedorDatosExtraidos DivConDisplayFlex">
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="TextUbuntu_Bold txt_ExtraGrande">
                            <?php prestamos_Controlador::ExtraerCantidad("En Solicitud"); ?>
                        </p>
            ...
            <div class="divContenedorDatosExtraidos DivConDisplayFlex">
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="TextUbuntu_Bold txt_ExtraGrande">
                            <?php prestamos_Controlador::ExtraerCantidad("Caducados"); ?>
                        </p>
            ...
            <div class="divContenedorDatosExtraidos DivConDisplayFlex">
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="TextUbuntu_Bold txt_ExtraGrande">
                            <?php prestamos_Controlador::ExtraerCantidad("Vigentes"); ?>
                        </p>
                        ...
                        <td>
                            <div class="Div_DeLa_SubTabla">
                                <table cellspacing="0" cellpadding="1" class="SubTabla TextMontserrat">
                                    <?php prestamos_Controlador::ExtraerTablas("Prestamos Vigentes"); ?>
